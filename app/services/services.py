...
def extract_vocabulary(text: str, model: str, client: openai.OpenAI) -> List[Dict]:
    ...
    - meaning 是该词的【直接中文翻译】(不要文章场景义, 也不要词典式多义项释义)
    - romaji 不由 AI 生成, 由 _reading_to_romaji 机械算出
    """
    prompt = f"""你是日语教师 + 日中翻译。请从以下日语文本中提取对初学者/中级学习者有难度的生词。

【选词标准】重点提取:
- 汉字复合词 (2 字及以上)
- 假名词: 平假名词语 (如 ゆっくり / こと / もの)、片假名词语 (含外来语、拟声拟态词)
- 生僻词语
- 专业术语
- 不常见的表达 / 惯用搭配
- 多义词 (优先常见义项)
...
- meaning: 中文翻译 (直接给出该词最自然的中文对应表达, 2-15 字)
...
【翻译要求 - 严格】:
- meaning 必须是该词的【直接中文翻译】, 就像把日语词翻成中文那样自然
- ❌ 不要写词典式多义项释义 (如 "高中生; 高等中学的学生")
- ❌ 不要用分号分隔多个义项
...
格式示例:
[
  {{"word": "高校生", "reading": "こうこうせい", "meaning": "高中生"}},
  {{"word": "逮捕", "reading": "たいほ", "meaning": "逮捕"}},
  {{"word": "サミット", "reading": "サミット", "meaning": "首脑会议"}},
  {{"word": "言及", "reading": "げんきゅう", "meaning": "提及"}},
