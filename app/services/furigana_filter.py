...
_COMMON_KANJI_BY_LEVEL = {
    1: set(
        "日一国人年大十二本中長出三時行見月分後前生五間上東四今金九入学高円子外八六下来気小七山話女北午百書先名川千水半男西電校語土木聞食車何南万白天母火右読友左休父雨"
    ),
    2: set(
        "気安会強同最勉私族店場体飲物使作町週新曜歩買歌鉄魚海図音園赤青黒茶黄明直計終開閉売考期記通試働住待取知答楽病院医薬昼夜春夏秋冬"
    ),
    3: set(
        "感想対別答義題続進復変敗夢術証都県度産約初習究解現規調情便理案伝界切短勢順質納察細資協済観能訪移減適配準導留"
    ),
}
